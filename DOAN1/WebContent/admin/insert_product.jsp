   ...
   %>
	...
	<form action ="/DOAN1/QUANLYSANPHAMsevlet"enctype="multipart/form-data" method="post">
                    ...
                    <table width="95%">
                        ...
                        <input type="text" class="pendek" name="TenSanPham"></td></tr>
                        <tr><td><b>Nơi Sản Xuất</b></td><td><input type="text" class="panjang"name="NoiSanXuat"></td></tr>
                            <tr><td><b>Giá Sản Phẩm</b></td><td><input type="text" class="panjang"name="GiaSanPham"></td></tr>
<!--                                 <tr><td><b>Ảnh Sản Phẩm</b></td><td><input type="text" class="panjang"name="AnhSanPham"></td></tr> -->
                                  <tr><td><b>Ảnh Sản Phẩm
            						<input type="file" name="file" />
                                		 
                                    <tr><td><b>Chi Tiết Sản Phẩm</b></td><td><input type="text" class="panjang"name="ChiTietSanPham"></td></tr>
